...
impl GPUOperation {
    ...
    pub fn get_shader_bytes(&self) -> &[u8] {
        match self {
            GPUOperation::Addition_F32 => ADD_SHADER_F32,
            GPUOperation::Subtract_F32 => SUB_SHADER_F32,
            GPUOperation::Multiply_F32 => MUL_SHADER_F32,
            GPUOperation::Divide_F32 => DIV_SHADER_F32,
            GPUOperation::Maximum_F32 => MAX_SHADER_F32,
            GPUOperation::Minimum_F32 => MIN_SHADER_F32,
            GPUOperation::ReLU_F32 => RELU_SHADER_F32,
            GPUOperation::Sigmoid_F32 => SIGMOID_SHADER_F32,
            GPUOperation::Softmax_F32 => SOFTMAX_SHADER_F32,
            GPUOperation::Conv1D_F32 => CONV1D_SHADER_F32,
            GPUOperation::Conv2D_F32 => CONV2D_SHADER_F32,
            GPUOperation::Conv3D_F32 => CONV3D_SHADER_F32,
            GPUOperation::MaxPool1D_F32 => MAXPOOL1D_SHADER_F32,
            GPUOperation::MaxPool2D_F32 => MAXPOOL2D_SHADER_F32,
            GPUOperation::MaxPool3D_F32 => MAXPOOL3D_SHADER_F32,
            GPUOperation::MatMul_F32 => MATMUL_SHADER_F32,
            GPUOperation::MatMul1D2D_F32 => MATMUL_1D_2D_SHADER_F32,
            GPUOperation::MatMul2D1D_F32 => MATMUL_2D_1D_SHADER_F32,
            GPUOperation::MatMul2D2D_F32 => MATMUL_2D_2D_SHADER_F32,
            GPUOperation::MatMul2D3D_F32 => MATMUL_2D_3D_SHADER_F32,
            GPUOperation::MatMul3D2D_F32 => MATMUL_3D_2D_SHADER_F32,
            GPUOperation::MatMul3D3D_F32 => MATMUL_3D_3D_SHADER_F32,
            GPUOperation::MatMul3D1D_F32 => MATMUL_3D_1D_SHADER_F32,
            GPUOperation::MatMul1D3D_F32 => MATMUL_1D_3D_SHADER_F32,
