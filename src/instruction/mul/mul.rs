...
use crate::{
    ...
    instruction::{
        ...
        mul::f32_f32_f32_cpu::f32_f32_f32_cpu,
    },
    tensor::TensorDesc,
...
impl Instruction for MulInstruction {
    ...
    fn record_into_command_buffer(
        ...
        let gpu_op = match (src1_dtype, src2_dtype, dst_dtype) {
            (DataType::Float, DataType::Float, DataType::Float) => {
                GPUOperation::Multiply_F32_F32_F32
            }
            _ => {
                return Err(format!(
                    "GPU Mul unimplemented for DataType src1:{:?}, src2:{:?}, dst:{:?}",
    ...
    fn execute_cpu(&self, cm: &ComputeManager) {
        ...
        match (src1_dtype, src2_dtype, dst_dtype) {
            ...
            _ => unimplemented!(
                "mul.rs unimplemented cpu instruction for DataType src1:{:?}, src2:{:?}, dst:{:?}",
                src1_dtype,
                src2_dtype,
                dst_dtype
            ),
