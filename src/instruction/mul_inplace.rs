...
#[derive(Clone)]
pub struct MulInplaceInstruction {
    pub dst: TensorId,
    pub src1: TensorId,
}

impl Debug for MulInplaceInstruction {
    fn fmt(&self, f: &mut Formatter<'_>) -> FmtResult {
        write!(f, "MulInplace(dst={}, src1={})", self.dst, self.src1)
    }
}

impl Instruction for MulInplaceInstruction {
    ...
    fn create_command_buffer(
        ...
        assert!(
            rank <= 8,
            "InplaceMul: tensor rank {} exceeds maximum supported rank of 8",
            rank
        );
        ...
        unsafe {
            ...
            let pipeline = gpu
                ...
                .get_pipeline(GPUMemoryOperation::MultiplyInplace)
                .ok_or(format!("MultiplyInplace pipeline not found"))?;
